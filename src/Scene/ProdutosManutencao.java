...
public class ProdutosManutencao extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        FXMLLoader loaderProdutosManutencao = new FXMLLoader(this.getClass().getResource("layoutProdutoManutencao.fxml"));

        ProdutosManutencaoController produtosManutencaoController = new ProdutosManutencaoController();
        loaderProdutosManutencao.setController(produtosManutencaoController);

        Parent root = loaderProdutosManutencao.load();
